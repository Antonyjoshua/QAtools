...
import type { FavoriteTimezone, ConversionHistoryEntry, TimezoneSettings, MeetingLocation } from "./types";

// Simplified port of src/lib/timezone/store.ts for the extension popup: drops the floating-popup
// chrome (isOpen/isPinned/activeTab) that only made sense for the website's portaled widget.
