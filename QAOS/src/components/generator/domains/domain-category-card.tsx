...
import type { DomainCategoryDef } from "@/lib/generator/domains/types";

export function DomainCategoryCard({ category, accent }: { category: DomainCategoryDef; accent: string }) {
  return (
    <Link
      href={`/generator/domain/${category.domainId}/${category.id}`}
