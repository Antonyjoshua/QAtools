...
import { QrBarcodeStudioClient } from "@/components/generator/tools/qr-barcode-studio-client";

export default function QrBarcodeStudioPage() {
  return (
    <div className="mx-auto max-w-6xl px-4 py-10 sm:px-6 lg:px-8">
      <Link href="/generator/category/ecommerce" className="mb-6 inline-flex items-center gap-1.5 text-sm text-muted-foreground hover:text-foreground">
