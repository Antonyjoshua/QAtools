...
import { useHistoryStore, type HistoryEntry } from "@/lib/calculator/store/history-store";
import { CATEGORY_META } from "@/lib/calculator/types";
    ...
    <div className="mx-auto max-w-5xl px-4 py-10 sm:px-6">
      ...
      {visible.length === 0 ? (
        <div className="glass-card flex flex-col items-center gap-3 rounded-2xl p-12 text-center text-muted-foreground">
          ...
          <Button size="sm" nativeButton={false} render={<Link href="/calculator">Browse calculators</Link>} />
        </div>
      ) : (
