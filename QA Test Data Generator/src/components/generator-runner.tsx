...
import { CodeView } from "@/components/data-view/code-view";
import { getCategory } from "@/lib/generators/categories";
import { getGeneratorBySlug } from "@/lib/generators/registry";
import type { GeneratorModule, OptionValues } from "@/lib/generators/types";
...
function GeneratorRunnerInner({ generator }: { generator: GeneratorModule }) {
  ...
  return (
    <div className="mx-auto max-w-6xl px-4 py-8 sm:px-6 lg:px-8">
      <Link href={`/category/${generator.category}`} className="mb-6 inline-flex items-center gap-1.5 text-sm text-muted-foreground hover:text-foreground">
